...
urlpatterns = [
	...
	url(r'^edit_reservation/(?P<reservation_id>\d+)/$', views.edit_reservation, name='edit-reservation'),
	url(r'^delete-reservation/(?P<reservation_id>\d+)/$', views.delete_reservation, name='delete_reservation'),
